...
{	
	...
	*/
	function register($info = array())
	{
		...
		*/
		$usergroup = 5;		// awaiting activation
		...
		*/
		else if($this->mybb->settings['regtype'] == "verify")
		{
			...
			$emailmessage = $this->lang->sprintf($this->lang->email_activateaccount, $user_info['username'], $this->mybb->settings['bbname'], $this->mybb->settings['bburl'], $user_info['uid'], $activationcode, $serverName);
